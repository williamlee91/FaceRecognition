...
class Model:
    ...
    MODEL_PATH = '/home/yuwangwang/FaceRecognization_Version2/model/me.face.model.h5'
...
if __name__ == '__main__':
    ...
    # 读取数据
    dataset = Dataset('/home/yuwangwang/FaceRecognization_Version2/face_data') 
    # 读取路径    
    path_name = '/home/yuwangwang/FaceRecognization_Version2/face_data'
    dataset.load()
    ...
    model.build_model(dataset, path_name)
    ...
    # 测试训练函数的代码
    model.train(dataset)
    model.save_model(file_path = '/home/yuwangwang/FaceRecognization_Version2/model/me.face.model.h5')
    
    """
     
    # 评估模型
    model = Model()
    model.load_model(file_path = '/home/yuwangwang/FaceRecognization_Version2/model/me.face.model.h5')
